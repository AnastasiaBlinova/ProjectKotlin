...
//                   Toast.makeText(requireContext(),"Ответьте на все вопросы", Toast.LENGTH_SHORT).show()
                picture?.let { it1 -> putInt("param4", it1) }
//              picture.let { it1 -> Toast.makeText(requireContext(),"Ответьте на все вопросы", Toast.LENGTH_SHORT).show() }
//              if(answer1 == null && answer2 == null && answer3 == null && picture == null)
//                   Toast.makeText(requireContext(),"Ответьте на все вопросы", Toast.LENGTH_SHORT).show()
...
//                        Toast.makeText(requireContext(),"Ответьте на все вопросы", Toast.LENGTH_SHORT).show()
            ...
            //if(binding.radioGroup1.isNotEmpty() && binding.radioGroup2.isNotEmpty() && binding.radioGroup3.isNotEmpty())
